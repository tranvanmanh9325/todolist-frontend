  ...
  return (
    <div ref={popupRef} className="select-date-popup">
      ...
      <div className="quick-options">
          ...
          <span className="icon">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              <g fill="currentColor" fillRule="evenodd">
                ...
                ></path>
                <text fontFamily="-apple-system, system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'"
                  fontSize="9" transform="translate(4 2)" fontWeight="500">
                  <tspan x="8" y="15" textAnchor="middle">13</tspan>
                </text>
              </g>
            </svg>
          </span>
        ...
        <div className="tomorrow" onClick={() => quickSelect(1)}>
          <span className="icon">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              <path
                fillRule="evenodd"
        ...
        <div className="this-weekend" onClick={() => { onChange(getThisWeekend()); onClose(); }}>
          <span className="icon">
            {/* SVG Weekend */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <div className="next-week" onClick={() => { onChange(getNextWeek()); onClose(); }}>
          <span className="icon">
            {/* SVG Next Week */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
