  ...
  return (
    <div className="quick-options">
      ...
      <div className="today" onClick={() => quickSelect(0)}>
        ...
        <span className="date">{todayDate.toLocaleDateString("en-GB", { weekday: "short" })}</span>
      </div>
      ...
      <div className="tomorrow" onClick={() => quickSelect(1)}>
        ...
        <span className="date">{tomorrowDate.toLocaleDateString("en-GB", { weekday: "short" })}</span>
      </div>

      {/* Next week */}
      <div className="next-week" onClick={() => handleSelect(nextWeekDate)}>
        <span className="left">
          <span className="icon">
            {/* SVG Next Week */}
        ...
        <span className="date">{formatDateShort(nextWeekDate)}</span>
      </div>

      {/* Next weekend */}
      <div className="next-weekend" onClick={() => handleSelect(nextWeekendDate)}>
        <span className="left">
          <span className="icon">
            {/* SVG Weekend */}
        ...
        <span className="date">{formatDateShort(nextWeekendDate)}</span>
      </div>
    </div>
  );
};
